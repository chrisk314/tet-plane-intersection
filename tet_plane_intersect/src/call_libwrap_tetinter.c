...
int main(int argc, char **argv) {
  ...
  // Call serial version of library function for batch intersections
  batch_intersect_tris(pp, normal, tets, n_tets, pint, int_area, int_center,\
      tri_num, tri_ptr);

  n_tris = tri_ptr[n_tets];
  ...
  // Call OpenMP version of library function for batch intersections
  batch_intersect_tris_omp(pp, normal, tets, n_tets, pint, int_area, int_center,\
      tri_num, tri_ptr);
